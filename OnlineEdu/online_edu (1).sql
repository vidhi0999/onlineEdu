...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2023 at 05:46 AM
...
id`,
`name
`, `email`, `message`, `created_date`) VALUES
...
id`,
`tutor_id
`, `name`, `logo`, `description`, `experience`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
id`,
`tutor_id
`, `course_id`, `course_name`, `student_id`, `student_userName`, `status`, `delete_flag`) VALUES
...
id`,
`student_id
`, `username`, `email`, `course_id`, `course_name`, `tutor_id`, `message`, `delete_flag`, `date_created`) VALUES
(1, '', 'vidhi', 'vidhi54@gmail.com', 0, 'php', 0, '123', 0, '2023-04-04',0);
...
id`,
`fullname
`, `username`, `email`, `phonenumber`, `pass`, `gender`, `filename`, `qualify`, `dob`) VALUES
...
(3, 'Vidhi Thummar', 'vidhi54', 'vidhi54@gmail.com', '9737465789', '123', 'Female', 'girl.jpeg', 'Btech', '2023-03-10');
...
(255) NOT NULL,
  `status` tinyint
(1) NOT NULL DEFAULT 0 COMMENT '0 = inactive,\\r\\n1 = active,\\r\\n2 = Blocked\r\n',
  `delete_flag` tinyint
(1) NOT NULL DEFAULT 0,
  `date_created` date NOT NULL,
  `date_updated` date NOT NULL
...
INSERT INTO `tutor_list` (`
id`,
`firstname`,
`middlename
`, `lastname`, `email`, `password`, `avtar`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
INSERT INTO `tutor_meta` (`
meta_id`,
`tutor_id
`, `dob`, `gender`, `contact`, `address`, `speciality`, `description`) VALUES
...
ALTER TABLE `admin`
  MODIFY `id` int
(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE `course_list`
  MODIFY `id` int
(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
ALTER TABLE `course_request`
  MODIFY `id` int
(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
ALTER TABLE `student`
  MODIFY `id` int
(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `tutor_list`
  MODIFY `id` int
(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
